...
SECRET_KEY = 'django-insecure-$bg13trdrfh8-^w1kq0ns^@#wezs&*0a=5++&w@4+u%d!o*-yo'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
                  'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles', 'main', 'users',
                  'cars',
                  'admins', 'crispy_forms', 'crispy_bootstrap4']
...
DATABASES = {'default': {'ENGINE': os.environ.get('DB_ENGINE'), 'NAME': os.environ.get('DB_NAME'),
